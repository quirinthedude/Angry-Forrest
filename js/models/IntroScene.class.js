class IntroScene {
  constructor(canvas) {
    ...
    this.scrollingText = new ScrollingText(
      this.ctx,
      "WELCOME TO ANGRY FORREST! USE LEFT AND RIGHT TO ADJUST TEXT SPEED. THIS IS THE STORY OF ENTIE, WHO CAME TO LIFE WHEN THE DESTRUCTION OF HIS FORMER WOODS ESCALATED. HELP ENTIE FIGHT BACK AGAINST THE ALIEN ROBOT AND HIS SLAVE GNOMES, AND AVENGE THE DAMAGE THEY HAVE ALREADY CAUSED. USE THE ARROW KEYS: LEFT TO GO LEFT, RIGHT TO GO RIGHT AND UP TO JUMP! COLLECT THE ACORNS HANGING IN THE TREES AND THROW THEM AT YOUR ENEMIES WITH SPACE. DO NOT WORRY IF YOU MISS. THEY WILL SIMPLY LAND ON THE GROUND AND CAN BE COLLECTED AGAIN. PRESS ENTER TO START AND HAVE FUN! LET ME KNOW WHETHER YOU LIKED OR DISLIKED THIS LITTLE GAME, OR IF YOU HAVE ANY IDEAS FOR IMPROVEMENT.",
